                ...
                switch ((c = fmt.charAt(i))) {
                    ...
                    case 'A':case 'a': case '上':
                        ...
                        if (fmt.substr(i, 3).toUpperCase() === "A/P") {
                           ...
                           q.t = 'T'; i+=5; hr='h'; }
				else if(fmt.substr(i,5).toUpperCase() === "上午/下午") { if(dt!=null) q.v = dt.H >= 12 ? "下午" : "上午"; q.t = 'T';
                            i += 5;
                            hr = 'h';
                        }
                        else {
                    ...
                    case ' ':
                        ...
                        ++i;
                        break;case '$': out[out.length] = {t:'t', v:'$'}; ++i; break;
                    default:
	...
	var i = 0, namelen = 0, name;
		...
		var o = ({
			...
			size: 0
                ...
                varctime = blob.read_shift(2) + blob.read_shift(2) + blob.read_shift(2) + blob.read_shift(2);
                if (ctime !== 0)
...
function parsexmlbool(value) {
    ...
    var utf8read = function utf8reada(orig) {
        ...
        while (i < orig.length) {
            ...
            d = orig.charCodeAt(i++);
            if (c > 191 && c < 224) {
                f = ((c & 31) << 6); f |= (d & 63); out += String.fromCharCode(f);
                continue;
            }
            e = orig.charCodeAt(i++);
            if (c < 240) {
...
function write_vt(s, xlsx) {
    ...
    var __toBuffer = function(bufs) {
        var x = [],w=10240;
        for (var i = 0; i < bufs[0].length; ++i) if(bufs[0][i]) for(var j=0,L=bufs[0][i].length;j<L;j+=w)
    ...
    var __hexlify = function(b, s, l) {
        var ss=[]; for(var i=s; i<s + l; ++i) ss.push(( "0"  + b[i].toString(16)).slice(-2)); return ss.join("");
    };
...
var ___lpstr = __lpstr;
    ...
    if (has_buf) {
        ...
        __lpstr = function lpstr_b(b, i) {
           ...
           var len = b.readUInt32LE(i); return len > 0 ? b.toString('utf8',i+4,i+4+len-1) : "";};
	__cpstr = function cpstr_b(b, i) { if(!Buffer.isBuffer(b)) return ___cpstr(b, i); var len = b.readUInt32LE(i);
    ...
    function ReadShift(size, t) {
        ...
        switch (t) {
            ...
            case 'lpstr-ansi':
                ...
                size = 4 + __readUInt32LE(this, this.l); break;
		case 'lpstr-cp': o = __cpstr(this, this.l); size = 4 + __readUInt32LE(this, this.l);
                break;
                    ...
                    case 8:
                        case -8:if (t === 'f') {
                           if(size == 8) oR = __double(this, this.l);
                            else oR = __double([this[this.l+7],this[this.l+6],this[this.l+5],this[this.l+4],this[this.l+3],this[this.l+2],this[this.l+1],this[this.l+0]], 0);this.l += 8;
                            return oR;
                        } else size = 8;
                    /* falls through */
                    case 16:
    ...
    var __writeUInt32LE = function (b, val, idx) {
        b[idx] = (val & 0xFF);
        b[idx + 1] = ((val >>> 8) & 0xFF);
   b[idx+2] = ((val >>> 16) & 0xFF); b[idx+3] = ((val >>> 24) & 0xFF); };
...
var end = Math.min(this.l + t, this.length);
	...
	var bufs = [], blksz = has_buf ? 256 : 2048;
        ...
        var push = function ba_push(buf) {
            endbuf();
            curbuf = buf;
           if(curbuf.l == null) curbuf.l = curbuf.length; next(blksz);
        };
...
var XLSLblBuiltIn = [
    ...
    function parse_Lbl(blob, length, opts) {
        ...
        if(flags & 0x20) name = XLSLblBuiltIn[name.charCodeAt(0)];var npflen = target - blob.l;
                ...
                for (C = 0; C != fields.length; ++C) {
					...
					out[R][C] = "##MEMO##" + (l7 ? parseInt(s.trim(), 10): dd.read_shift(4));
                        ...
                        case 'Y':
                            ...
                            break;case 'O': out[R][C] = -dd.read_shift(-8, 'f'); break;
			...
			if(s.length === 0) cell.t = 'z';
				...
				if(s.charCodeAt(1) == 0x22 && s.charCodeAt(s.length - 1) == 0x22) { cell.t = 's'; cell.v = s.slice(2,-1).replace(/""/g,'"'); }
				 ...
				 if(o.cellText !== false) cell.w = s;
					...
					cell.z = o.dateNF || SSF._table[14];
					var k = 0;
				if(_re && s.match(_re)){ s=dateNF_fix(s, o.dateNF, (s.match(_re)||[])); k=1; }if (o.cellDates) {
								cell.t = 'd';
						...
						if(o.cellText !== false)cell.w = SSF.format(cell.z, cell.v instanceof Date ? datenum(cell.v) : cell.v);if(!o.cellNF) delete cell.z;
				} else {
						cell.t = 's';
						cell.v = s;
				}
...
/*function find_mdw_wpx(wpx) {
	...
	(t[0].match(tagregex)||[]).forEach(function(x) {
			...
			case '<extLst': case '<extLst>': case '</extLst>': break;
			case '<ext': pass = true; break;
			case '</ext>': pass = false; break;default:
                    if (opts && opts.WTF) {
...
var cellXF_bool = [ "applyAlignment", "applyBorder", "applyFill", "applyFont", "applyNumberFormat", "applyProtection", "pivotButton", "quotePrefix" ];
	...
	(t[0].match(tagregex)||[]).forEach(function (x) {
			...
			case '<xf': case '<xf/>':
                ...
                case '<protection/>':
                    break;/* note: sometimes mc:AlternateContent appears bare */
			case '<AlternateContent': pass = true; break;
			case '</AlternateContent>': pass = false; break;
...
function sheet_insert_comments(sheet, comments) {
    ...
    function write_comments_xml(data) {
        ...
        data.forEach(function (x) {
             x[1].forEach(function (w) { var a = escapexml(w.a);
    ...
    function parse_RgbExtra(blob, length, rgce, opts) {
        ...
        for (var i = 0; i !== rgce.length; ++i) {
			...
			case 'PtgElfColSV': /* TODO: PtgElfColSV -> PtgExtraElf */
				throw "Unsupported " + rgce[i][0];default:
                    break;
            }
        }
	...
	var stack = [], e1, e2,  c, ixti=0, nameidx=0, r, sname="";
        ...
        for (var ff = 0, fflen = formula[0].length; ff < fflen; ++ff) {
			...
			case 'PtgSxName': /* [MS-XLS] 2.5.198.91 TODO -- find a test case */
				throw new Error('Unrecognized Formula Token: ' + String(f));default:
...
function get_sst_id(sst, str, rev) {
	...
	if(p.t === 'd' && typeof p.v === 'string') p.v = parseDate(p.v);
        ...
        if(!opts.cellStyles) return;if (fillid!= null) try {
...
function parse_ws_xml_sheetviews(data, wb) {
	...
	return writextag("sheetViews", writextag("sheetView", sheetViewPane, sview), {});
    }
    ...
    function parse_wb_xml(data, opts) {
        ...
        data.replace(tagregex, function xml_wb(x, idx) {
            ...
            switch (strip_ns(y[0])) {
                ...
                case '<workbookView': case '<workbookView/>':
                    delete y[0];
                    wb.WBView.push(y);
                    break;
                case '</workbookView>':
                ...
                case '<AlternateContent':
                   case '<AlternateContent>': pass = true;
                    break;
                case '</AlternateContent>':
                    pass = false;
                    break;
                ...
                /* TODO */
			case '<revisionPtr': break;default:
	...
	supbooks.XTI = [];
        ...
        recordhopper(data, function hopper_wb(val, R_n, RT) {
			...
			case 0x0C01: /* 'BrtRevisionPtr' */
                ...
                case 0x0023: /* 'BrtFRTBegin' */
                    state.push(R_n);pass = true;
                    break;
                case 0x0024: /* 'BrtFRTEnd' */
                    state.pop();pass = false;
                    break;
                case 0x0025: /* 'BrtACBegin' */
                   state.push(R_n); pass = true; break;
                case 0x0026: /* 'BrtACEnd' */
...
var names = wb.Workbook.Names;
	...
	if(cell.F && cell.F.slice(0, ref.length) == ref) {
        ...
        switch (cell.t) {
            case 'z':
               if(!opts.sheetStubs) return ""; break;
            case 'n':
                t = 'Number';
                p = String(cell.v);
                break;
            ...
            case 'd':
               ...
               if(cell.z == null) cell.z = cell.z || SSF._table[14]; break;
            case 's':
                t = 'String';
                p = escapexlml(cell.v || "");
                break;
...
*/
    ...
    function safe_format_xf(p, opts, date1904) {
        ...
        if (!opts || opts.cellText !== false) try {
            ...
            } catch(e) { if(opts.WTF) throw e; }if (opts.cellDates && fmtid && p.t == 'n' && SSF.is_date(SSF._table[fmtid]|| String(fmtid))) {
                var _d = SSF.parse_date_code(p.v);
                if (_d) {
                    p.t = 'd';
                    p.v = new Date(_d.y, _d.m - 1, _d.d, _d.H, _d.M, _d.S, _d.u);
...
if(file_depth == 0 && Rn != 'BOF') continue;
				...
				case 'CalcCount':
                    ...
                    case 'ForceFullCalculation':
                        ...
                        break;
                    case 'WsBool':
                        if(val.fDialog) out["!type"] = "dialog";break; // TODO
                    case 'XF':
                        XFs.push(val);
                        break;
                    case 'ExtSST':
...
0x0007:2
                    ...
                    default:
                        switch (R.n) { /* nested */
                            ...
                            case 'Row': {
                                var rowobj = {};
                                if(val.level != null) { rowinfo[val.r] = rowobj; rowobj.level = val.level; }if (val.hidden) {
...
function write_biff_buf(wb, opts) {
    ...
    var HTML_ = (function () {
		...
		var merges = [];
			...
			if(hd == "<tr") {
                    ++R;
                   if(opts.sheetRows && opts.sheetRows <= R) { --R; break; } C = 0;
                    continue;
                }
				...
				for(var midx = 0; midx < merges.length; ++midx) {
                    ...
                    if (!m.length) continue;
                        ...
                        if (!isNaN(fuzzynum(m))) o = {t: 'n', v: fuzzynum(m)};
	...
	for(; _R < rows.length && R < sheetRows; ++_R) {
		...
		var elts = (row.children);
			...
			if(v != null) {
                ...
                if(o.z === undefined && z != null) o.z = z;if (opts.dense) {
		...
		str = str.replace(/<!--([\s\S]*?)-->/mg,"").replace(/<!DOCTYPE[^\[]*\[[^\]]*\]>/gm,"");
            while ((Rn = xlmlregex.exec(str))) switch ((Rn[3] = Rn[3].replace(/_.*$/, ""))) {
                ...
                case '??':
					...
					if(ctag['number-columns-repeated']) colpeat = parseInt(ctag['number-columns-repeated'], 10);
                        ...
                        if(atag.Target) q.l = atag;if (comments.length > 0) {
                            q.c = comments;
                            comments = [];
                        }
                ...
                case 'font-face-decls': // 3.14 <office:font-face-decls>
								case 'master-styles': //3.15.4 <office:master-styles> -- relevant for FODSif (Rn[1] === '/') {
			...
			case 'binary-data': break; // 10.4.5 TODO: b64 blob
                ...
                /* 9.2 Advanced Tables */case 'table-source':
                    break; // 9.2.6case 'scenario': break; // 9.2.6
...
function read_prn(data, d, o, str) {
	...
	if(o.cellStyles) { o.cellNF = true; o.sheetStubs = true; }
        ...
        if (!o.type) o.type = (has_buf && Buffer.isBuffer(data)) ? "buffer" : "base64";
        if (o.type == "file") {
            o.type = has_buf ? "buffer" : "binary"; d = read_binary(data); }
	if(o.type == "string") { str = true; o.type = "binary"; o.codepage = 65001;
            d = bstrify(data); }
	if(o.type == 'array' && typeof Uint8Array !== 'undefined' && data instanceof Uint8Array && typeof ArrayBuffer !== 'undefined') {
        ...
        switch ((n = firstbyte(d, o))[0]) {
            case 0xD0:
               if(n[1] === 0xCF && n[2] === 0x11 && n[3] === 0xE0 && n[4] === 0xA1 && n[5] === 0xB1 && n[6] === 0x1A && n[7] === 0xE1) return read_cfb(CFB.read(d, o), o); break;
            case 0x09:
...
function make_json_row(sheet, r, R, cols, header, hdr, dense, o) {
	...
	var out = [];
        ...
        for (R = r.s.r + offset; R <= r.e.r; ++R) {
            var
                    row= make_json_row(sheet, r, R, cols, header, hdr, dense, o);
